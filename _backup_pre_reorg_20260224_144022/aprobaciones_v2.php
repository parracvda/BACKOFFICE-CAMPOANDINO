...
if (!isset($_SESSION['usuario']) || (stripos(trim($tipoUsuario), 'APROBADOR') === false && !in_array($currentUser, $allowedApprovers))) {
...
<div class="container">
    <header style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px">
        ...
        <div style="display:flex;gap:8px;align-items:center">
            <button class="btn-panel" id="btn-panel" onclick="location.href='panel.html'">Panel</button>
