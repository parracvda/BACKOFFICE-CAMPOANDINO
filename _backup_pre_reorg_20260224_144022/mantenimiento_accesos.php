...
if ($currentUser !== 'jparra') {
    $ok = false;
    try { if ($currentId > 0 && current_user_has_feature_local($conn, $currentId)) $ok = true; } catch(Exception $e) { $ok = false; }
    if (!$ok) {
...
<body>
  <div class="card">
    ...
    <div class="row">
      ...
      <a href="panel.html" style="margin-left:auto">Volver al panel</a>
    </div>
