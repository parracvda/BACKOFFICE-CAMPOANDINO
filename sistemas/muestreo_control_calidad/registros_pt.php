...
<head>
    ...
    <script src="registros_pt.js"></script>
</head>
<body>
    <h1>Registros</h1>
    ...
    <label>
        ...
        <select id="tipoMaterial">
            ...
            try {
                ...
                $query = "SELECT IdTipoMaterial, TipoMaterial FROM sig_vcc_tipomaterial_pt";
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#exportToCSV').on('click', function() {
                ...
                var endDate = $('#endDate').val();
                var tipoMaterial = $('#tipoMaterial').val();
                var url = 'exportar_pt.php?export=1&startDate=' + startDate + '&endDate=' + endDate + '&tipoMaterial=' + tipoMaterial;
