...
<head>
    ...
    <script src="registros_de.js"></script>
</head>
<body>
    <h1>Registros</h1>
    ...
    <label>
        ...
        <select id="tipoMaterial">
            ...
            try {
                ...
                $query = "SELECT IdTipoMaterial, TipoMaterial FROM sig_vcc_tipomaterial_de";
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#exportToCSV').on('click', function() {
                ...
                var endDate = $('#endDate').val();
                var tipoMaterial = $('#tipoMaterial').val();
                var url = 'exportar_de.php?export=1&startDate=' + startDate + '&endDate=' + endDate + '&tipoMaterial=' + tipoMaterial;
