    ...
    <label>
        ...
        <select id="tipoMaterial">
            ...
            try {
                ...
                $query = "SELECT IdTipoMaterial, TipoMaterial FROM sig_vcc_tipomaterial";
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#exportToCSV').on('click', function() {
                ...
                var endDate = $('#endDate').val();
                var tipoMaterial = $('#tipoMaterial').val();
                var url = 'datos2.php?export=1&startDate=' + startDate + '&endDate=' + endDate + '&tipoMaterial=' + tipoMaterial;
