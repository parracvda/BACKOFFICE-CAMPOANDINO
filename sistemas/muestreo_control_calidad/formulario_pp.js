var is_cmbProceso_pordefecto=null
var ls_accion
...
$(() => {
  ...
  idxdpFechaProduccion=$('#dpFechaProduccion').dxDateBox({
    displayFormat: 'dd/MM/yyyy',
    type: 'date',
    value: now,
    inputAttr: { 'aria-label': 'Date' },
  ...
  $('#btnRegistros').dxButton({
    ...
    width: 120,
    onClick() {
      window.location.href = 'registros_pp.php';
    },
  });
  ...
  // var dxcmbMaquina = $("#cmbMaquina").dxSelectBox("instance").option("value");
  // var dxcmbProceso = $("#cmbProceso").dxSelectBox("instance").option("value");
  ...
  // dxdpFechaProduccion = formatDate( dxdpFechaProduccion )
  ...
  if (ls_accion =="agregar"){
    ...
    // if ( dxcmbMaquina == null ){
    //   alert("Debe ingresar Maquina")
    //   return false
    // } 
    // if ( dxcmbProceso == null ){
    //   alert("Debe ingresar Proceso")
    //   return false
    // } 
    // if ( dxcmbObservacionPaletizado == null ){
    //   alert("Debe ingresar Observacion Paletizado")
    //   return false
    // } 
  }
  ...
  function btnAceptar_click()
  {
    ...
    var dxdpFechaProduccion = $("#dpFechaProduccion").dxDateBox("instance").option("value");
    var dxtxtLoteProduccion = $("#txtLoteProduccion").dxTextBox("instance").option("value");
    var dxtxtCodigoTrazabilidad = $("#txtCodigoTrazabilidad").dxTextBox("instance").option("value");
    var dxcmbMaquina = $("#cmbMaquina").dxSelectBox("instance").option("value"); 
    var dxcmbProceso = $("#cmbProceso").dxSelectBox("instance").option("value"); 
    ...
    if (ls_accion =="agregar" )
    {
      ...
      +dxtpHoraFin+","+dxcmbCampana+","+dxtxtCodigoPallet+","+dxdpFechaProduccion+","+dxtxtLoteProduccion+","
      +dxtxtCodigoTrazabilidad+","+dxcmbMaquina+","+dxcmbProceso+","+dxtxtDestino+","+dxtxtCantidad+","
  ...
  $.ajax({ 
   ...
   // txtCodigoTrazabilidad
   $('#txtCodigoTrazabilidad').dxTextBox({
    inputAttr: {'aria-label': 'Name'},
  }),

    //COMBO MAQUINA CON PROCESO
  $.ajax({ 
    url: 'datos_pp.php',
    type: 'GET',
    data: { action: 'cmbMaquina' },
    dataType: 'json',
    success(data) {
        
        console.log(data)

        idxcmbMaquina=$('#cmbMaquina').dxSelectBox({ 
        dataSource: data,
        displayExpr: 'Maquina',
        valueExpr: 'IdMaquina',
          ...
          onValueChanged(val) {
            ...
            $.ajax({ 
              url: 'datos_pp.php',
              type: 'GET',
              data: { action: 'cmbProceso' ,parametros: val.value},
              dataType: 'json',
              success(data) {
                  
                  console.log("proceso",data);
      
                  idxcmbProceso=$('#cmbProceso').dxSelectBox({ 
                  dataSource: data,
                  displayExpr: 'Proceso',
                  valueExpr: 'IdProceso',
                  value: is_cmbProceso_pordefecto,
                }).dxSelectBox("instance");
              },
              error() {             
                      console.error('Error cmbProceso:', textStatus, errorThrown);
              }, 
            }); 
    ...
    error() {             
            console.error('Error cmbMaquina:', textStatus, errorThrown);
    }, 
  }),
  ...
  $.ajax({ 
    ...
    error() {             
            console.error('Error cmbTipoMaterialPP:', textStatus, errorThrown);
    }, 
  })
